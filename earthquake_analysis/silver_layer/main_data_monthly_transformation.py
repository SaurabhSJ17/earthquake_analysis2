...
display(dbutils.fs.ls("dbfs:/mnt/sj-container2/bronze_layer/monthly_data/2025-05-10/"))
...
input_path= f"/mnt/sj-container2/bronze_layer/monthly_data/{date_val}/monthly_data{date_val}.json"
...
df.write.mode('overwrite').format('parquet').save(f'/mnt/sj-container2/silver_layer/{date_val}/earthquake_monthly_data')

# COMMAND ----------

display(dbutils.fs.ls(f"/mnt/sj-container2/silver_layer/{date_val}/earthquake_monthly_data"))
